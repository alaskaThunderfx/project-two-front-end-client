const sofa = 'The large, green-cloth-covered sofa you woke up on... You move around the pillows and lift the cushions to see if anything is there to give you a clue as to where you are, and there isn\'t... It was pretty comfy though!'

const doors = 'There are three doors here... The <u>first door</u> has the number 1 above it, the <u>second door</u> has the number 3 above it, and the <u>third door</u> has no number.'
...
const table = 'This is a nice console table! It doesn\'t have much on top, however, there appears to be a <u>drawer</u> in it.'

const drawer = 'This drawer doesn\'t appear to have anything preventing you from Opening it...'
...
const pedestal = 'This pedestal has nothing on it... The top of it is dusty, but there is a dustless square in the center of the pedestal... Maybe something was recently moved from here?'
